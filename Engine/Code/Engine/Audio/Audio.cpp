...
void AudioSystem::PlaySound( SoundID soundID, float volumeLevel, bool looping)
{
	...
	if( channelAssignedToSound )
	{
		...
		m_registeredChannels[soundID] = channelAssignedToSound;
	}
}
...
void AudioSystem::StopSound(SoundID soundID)
{
	...
	if (!sound)
		return;
	FMOD::Channel* channelAssignedToSound = nullptr;
	channelAssignedToSound = m_registeredChannels[soundID];
	StopChannel(channelAssignedToSound);
// 	m_fmodSystem->getChannel(soundID, &channelAssignedToSound);
// 
// 	StopChannel(channelAssignedToSound);
}
