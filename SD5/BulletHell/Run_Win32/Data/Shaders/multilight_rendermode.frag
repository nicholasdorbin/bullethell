   ...
   float inner_power, float outer_power ) 
{
   ...
   //outColor2 = VectorAsColor(vector_to_light);
...
void main()
{
   ...
   //outColor2 = VectorAsColor(emissive_color);
   ...
   //outColor2 = (VectorAsColor(surface_tan) + diffuse) / 2.f;
   //return;
   ...
   normal = normalize(normal);
	...
	normal = normal * tbn;
   //outColor2 = VectorAsColor(normal);
   ...
   //outColor2 = vec4(ambient_color, 1.0f);
   ...
   //final_color = clamp(final_color, 0.f, 1.f);
   //final_color -= vec4(1.f);
   //final_color = clamp(final_color, 0.f, 1.f);
   
   //outColor2 = diffuse;
   //outColor2 = VectorAsColor(passTangent);
   //outColor2 = UVAsColor(passUV0);
   ...
   else if (gRenderState == 1)
   {
	outColor = passColor;
   }
   else if (gRenderState == 2)
   {
	outColor = VectorAsColor(surface_normal);
   }
   else if (gRenderState == 3)
   {
	outColor = VectorAsColor(passTangent);//UVAsColor(passUV0);
   }
